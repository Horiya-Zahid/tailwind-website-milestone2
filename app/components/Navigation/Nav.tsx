    ...
    <div className='h-[12vh] bg-white'>
        <div className='sm:w-[90%] w-[95%] mx-auto flex h-[100%] items-center justify-between'>
            ...
            <div className='flex items-center space-x-4'>
                <button className='px-6 py-2 sm:px-8 sm:py-3 text-[14px] sm:text-[16px] bg-blue-950 transition-all 
                duration-200 hover:bg-red-500 flex items-center rounded-md space-x-2 text-white'>
                    <span>
                ...
                {/* cart button */}
                <button className='sm:px-6 sm:py-3 px-4 py-2 hover:bg-green-500 transition-all 
                duration-200 bg-orange-600 flex items-center rounded-md text-white'>
