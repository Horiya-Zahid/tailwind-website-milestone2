        ...
        <div className='W-[80%] relative z-[20] mx-auto grid  grid-cols-1 lg:grid-cols-2 items-center gap-[3rem]'>
            ...
            <div>
                ...
                <p className='text-[17px] mt-[1rem] text-white opacity-50'>
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Obcaecati quasi dicta odio odit sunt tenetur eos 
                    consequatur quisquam. Excepturi iusto praesentium consectetur odit, quidem quaerat </p>
                        ...
                        <div className='w-[3rem] h-[3rem] bg-red-500 rounded-full flex items-center justify-center flex-col'>
                            <BiPhone className='w-[1.7rem] h-[1.7rem] text-white '/>
                             ...
                             <div>
                                ...
                                <h1 className='text-[30px] text-yellow-300 font-bold'>+0156 849 562</h1>
                             </div>
                    </div>
            </div>
            {/* form */}
